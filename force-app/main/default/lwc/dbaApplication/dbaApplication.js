...
export default class DbaApplication extends LightningElement {
    ...
    //picklist handler value of "other" for All Insure, Contract , Countries
   modalShowHidehandle(event) {
    ...
    //Requested Documents type of Organize picklist handle
    ...
    submitForm() {
        ...
        if (isAllInputsCorrect) {
            //contractInformationa add record type
            this.spinner = true;
            //this.primeContractData['recordTypeId'] = this.contractId;

            //REInformation add record type           
            //this.primeREInformationData['recordTypeId'] = this.locationId;
